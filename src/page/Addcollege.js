            ...
            <div className="col-md-6">
              <form>
                <div className="form-group">
                  ...
                  {this.state.isEmpty && !this.state.collegeName && (
                  ...
                  {this.state.isEmpty && !this.state.address && (
                    <span style={{ color: "red", textAlign: "center" }}>
                      Required
                    </span>
                  )}
                  ...
                  {this.state.isEmpty && !this.state.city && (
                    <span style={{ color: "red", textAlign: "center" }}>
                      Required
                    </span>
                  )}
                  ...
                  {this.state.isEmpty && !this.state.mobileNo && (
                    <span style={{ color: "red", textAlign: "center" }}>
                      Required
                    </span>
                  )}
