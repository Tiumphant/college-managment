...
function Dashboard() {
  ...
  return (
    <Navbar
      expand="lg"
      className="bg-body-tertiary px-3 shadow-sm"
      sticky="top"
    >
      <Container>
        <Navbar.Brand href="/">
            ...
            {!auth ? (
              ...
              <>
                ...
                <NavDropdown title="College" id="college-nav-dropdown">
                  <NavDropdown.Item as={Link} to="/Addcollege">
                    Add College
                  </NavDropdown.Item>
                  <NavDropdown.Item as={Link} to="/Collegelist">
                    College List
                  </NavDropdown.Item>
                </NavDropdown>

                <NavDropdown title="Student" id="student-nav-dropdown">
                  <NavDropdown.Item as={Link} to="/Studentform">
                    Add Student
                  </NavDropdown.Item>
                ...
                <NavDropdown title="Marksheet" id="marksheet-nav-dropdown">
                  <NavDropdown.Item as={Link} to="/Marksheetform">
                    Add Marksheet
                  </NavDropdown.Item>
                  <NavDropdown.Item as={Link} to="/Marksheetlist">
                    Marksheet List
                  </NavDropdown.Item>
                </NavDropdown>

                <NavDropdown title="Role" id="role-nav-dropdown">
                  <NavDropdown.Item as={Link} to="/Addrole">
                    Add Role
                  </NavDropdown.Item>
                  <NavDropdown.Item as={Link} to="/Rolelist">
                    Role List
                  </NavDropdown.Item>
                </NavDropdown>
